...
# Download DarcyFlow data from PDEBench and set file path below: https://github.com/pdebench/PDEBench
data_folder = '../../PDEBench/pdebench_data/2D/DarcyFlow/'  #NOTE(MS) replace with your file path
